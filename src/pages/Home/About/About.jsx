...
const About = () => {
  ...
  return (
    <div className='flex lg:flex-row flex-col lg:gap-0 gap-10 justify-center my-20'>
      {/* text info  */}
      <div data-aos="fade-up" className='space-y-8 md:w-[50%]'>
      <h3 className='text-[#ED4A43] font-bold'>About Event Masters Hub</h3>
      <h2 className="md:text-5xl text-3xl font-bold md:w-[500px]">What We do, We do  With Passion</h2>
      <p className='md:text-2xl text-xl'>"Event Masters Hub" is your one-stop online destination for event managing expertise and resources.</p>
      ...
      {/* image  */}
      <div data-aos="fade-down" className='md:w-[50%] w-full'>
